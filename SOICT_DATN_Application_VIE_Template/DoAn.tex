...
% (Phần phụ lục đặc tả use case phụ trợ đã được bỏ: 6 use case chính đã đặc tả
%  chi tiết trong Chương 2, các chức năng phụ trợ đã nêu ở bảng Yêu cầu chức năng.)
\end{document}
