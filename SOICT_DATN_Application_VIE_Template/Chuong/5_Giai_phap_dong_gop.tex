...
\textbf{Kết quả.} Việc trừ trung bình nâng độ nhất quán âm thanh từ $0.06$ lên $0.34$; hành trình hai màu đạt kiểm định KS $= 0.21$ và giảm độ chênh nhịp độ giữa các bước từ $31$ xuống $2.7$ BPM (mục~\ref{subsection:eval-color}). Với gợi ý bài tương tự, độ nhất quán tâm trạng đạt $\approx 0.94$ (mục~\ref{subsection:eval-similar}). Như vậy thuật toán vừa khớp cảm xúc vừa tạo ra danh sách nghe đồng nhất.
