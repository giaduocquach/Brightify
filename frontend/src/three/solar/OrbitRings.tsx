...
export default function OrbitRings() {
  const geometries = useMemo(
    () =>
      // heliocentric, near-circular orbits only — skip the Moon (orbits Earth) and
      // the comet (eccentric); their paths wouldn't be these centred circles.
      BODIES.filter((b) => !b.parent && !b.eccentricity).map((b) => {
        const pts: number[] = [];
